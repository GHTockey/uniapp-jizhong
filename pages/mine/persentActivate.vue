<template>
	<view class="persent_activate_container">
		<!-- 标题栏 -->
		<NavBar showBack>
			<template #title>
				<text>卡片激活</text>
		...
		<!-- 头部样式 -->
		<view class="persent_activate_header">
			<image class="w-[486rpx] absolute right-0 bottom-[20rpx]"
				src="../../static/images/persent-activate-icon.png" mode="widthFix"></image>
			<image class="w-[360rpx] absolute top-1/2 -translate-y-1/2 left-[20rpx]"
				src="../../static/images/persent-activate-txt.svg" mode="widthFix"></image>
		</view>

		<!-- 输入卡号/密码 -->
		<view class="persent_activate_input_box">
			<view class=" h-[100rpx] flex gap-2 items-center bg-[#ececec] rounded-[14rpx] px-4">
				<image class="w-[40rpx]" src="../../static/icon/persent-card-num.svg" mode="widthFix"></image>
				<input v-model="formData.cardNum" class="flex-1 text-[30rpx]" placeholder="请输入卡片号码" />
			</view>
			<view class=" h-[100rpx] flex gap-2 items-center bg-[#ececec] rounded-[14rpx] px-4">
				<image class="w-[40rpx]" src="../../static/icon/persent-card-pwd.svg" mode="widthFix"></image>
		...
		<!-- 操作须知 -->
		<view class="persent_activate_operation_box">
...
.persent_activate_container {
	...
	.persent_activate_header {
		position: relative;
		height: 350rpx;
		width: 100%;
	}

	.persent_activate_input_box {
	...
	.persent_activate_operation_box {
		margin-top: 70rpx;
