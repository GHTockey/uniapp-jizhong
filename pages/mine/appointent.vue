<template>
	...
	<view v-if="is_loading">
		<view class="nav_list" :style="{ position: 'sticky', top: statusBarHeight + 40 + 'px' }">
			<view class="category_item" @tap="change_nav" :data-nav_index="index" :key="index"
				...
				<view class="container_box">
					...
					<view class="product_item_v company_box" style="padding:25rpx 0;padding-top:15rpx">
						<view class="hang11">
							...
							<view class="daohang_box">
								...
								<image @click="makePhoneCall" :data-userphone="item.shop_phone" class="daohang"
					...
					<view class="hang3" style="border-bottom: 0;">
						...
						<view v-if="item.stat == 1" class="right"
							...
							<image @click="open_img" :data-qrcodetrial="item.qrcode_trial" class="left"
								style="margin:0;" mode="widthFix" :src="item.qrcode_trial"></image>
					...
					<view class="hang3" style="border-bottom: 0;" v-if="type == 2">
						<image @click="makePhoneCall" :data-userphone="item.phone" class="lianxi6" mode="widthFix"
