	...
	<view class="present_activate_container"
		...
		<view class="present_activate_header">
			<image class="w-[486rpx] absolute right-0 bottom-[20rpx]"
				src="https://saas.jizhongkeji.com/static/jzkj/static/images/present-activate-icon.png" mode="widthFix">
			</image>
			<image class="w-[360rpx] absolute top-1/2 -translate-y-1/2 left-[20rpx]"
				src="https://saas.jizhongkeji.com/static/jzkj/static/images/present-activate-txt.svg" mode="widthFix">
			</image>
		</view>
		...
		<view class="present_activate_input_box">
			<view class=" h-[100rpx] flex gap-2 items-center bg-[#ececec] rounded-[14rpx] px-4">
				<image class="w-[40rpx]" src="https://saas.jizhongkeji.com/static/jzkj/static/icon/present-card-num.svg"
					mode="widthFix"></image>
				<input v-model="formData.cardNum" class="flex-1 text-[30rpx]" placeholder="请输入卡片号码" />
			</view>
			<view class=" h-[100rpx] flex gap-2 items-center bg-[#ececec] rounded-[14rpx] px-4">
				<image class="w-[40rpx]" src="https://saas.jizhongkeji.com/static/jzkj/static/icon/present-card-pwd.svg"
					mode="widthFix"></image>
		...
		<view class="flex items-center justify-center gap-2 mt-[216rpx]">
			<image class="w-[31rpx] h-[31rpx]"
				src="https://saas.jizhongkeji.com/static/jzkj/static/icon/sj-mobile.svg" />
			<text @click="makePhoneCall('18888888888')">商家客服热线：18888888888</text>
		</view>
	</view>
</template>
