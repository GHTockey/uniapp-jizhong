...
.ActionSheetSlotComponentBody {
	...
	.goods-img-price-box {
		...
		.goods-price-box {
			...
			.goods-price-unit {
				...
				font-weight: 500;
				color: #999999;
				line-height: 55.56rpx;
			}
		}
	}

	// 商品参数标题
	.goods-params-box .goods-params-title,
	.goods-buy-num-box .goods-params-title {
		height: 40.97rpx;
		font-size: 29.17rpx;
	...
	.goods-params-box {
		...
		.goods-params-item-box {
			...
			// 选中效果
			.goods-params-item.active {
				border: 2.78rpx solid #eb2c2a;
			}
